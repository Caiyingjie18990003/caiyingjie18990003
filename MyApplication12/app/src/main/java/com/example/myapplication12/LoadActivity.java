...
import com.example.myapplication12.bean.UserInfo;
import com.example.myapplication12.database.UserDBHelper;
import com.example.myapplication12.util.DateUtil;
import com.example.myapplication12.util.ViewUtil;
...
public class LoadActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990003 蔡英杰"};
