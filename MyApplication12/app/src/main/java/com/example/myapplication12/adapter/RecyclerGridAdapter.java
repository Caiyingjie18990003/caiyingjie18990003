...
import com.example.myapplication12.LaunchImproveActivity;
import com.example.myapplication12.LoadActivity;
import com.example.myapplication12.R;
import com.example.myapplication12.bean.GoInfo;
import com.example.myapplication12.widget.RecyclerExtras.OnItemClickListener;
import com.example.myapplication12.widget.RecyclerExtras.OnItemLongClickListener;
...
public class RecyclerGridAdapter extends RecyclerView.Adapter<ViewHolder> implements OnItemClickListener, OnItemLongClickListener{
    ...
    public void onItemClick(View view, int position) {
        if(position == 0) {
            Intent intent = new Intent(mContext, LaunchImproveActivity.class);
